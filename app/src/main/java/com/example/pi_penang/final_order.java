...
public class final_order extends AppCompatActivity implements View.OnClickListener{
    ...
    final String trigle = homepage.getTriggle();
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.cancelButton:
                ...
                Toast.makeText(getApplicationContext(),"You have successfully canceled your order!",Toast.LENGTH_LONG).show();
                finish();
                break;
            ...
            case R.id.backButton:
                Intent i = new Intent(final_order.this, homepage.class);
                startActivity(i);
                finish();
                break;
        }
